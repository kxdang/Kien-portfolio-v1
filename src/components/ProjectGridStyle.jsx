    ...
    return (
      <div className="ProjectGrid-Container">
        ...
        <ProjectGridCard
          ...
          img={require("../images/projects/yahtzee.png")}
        />

        <ProjectGridCard
          name={projects[7].projectName}
          built={projects[7].built}
          link={projects[7].projectLink}
        ...
        <ProjectGridCard
          name={projects[3].projectName}
          built={projects[3].built}
          link={projects[3].projectLink}
        ...
        />
        <ProjectGridCard
          name={projects[12].projectName}
          built={projects[12].built}
          link={projects[12].projectLink}
