  ...
  static defaultProps = {
    projects: [
      ...
      },
      {
        key: 16,
        year: "2020",
        projectName: "Basic Dice Roller",
        projectLink: "https://kien-react-colour-palette.netlify.com/",
        built: "React",
        github: "https://github.com/kxdang/react-dice-roller",
      },
      {
        key: 8,
        year: "2020",
    ...
    return (
      <PageTransition>
        <div className="c-content-box project">
          ...
          <HeadlineWithFocus>Projects</HeadlineWithFocus>
          <div className="slider-container">
            <Slider
              ...
              max={1}
              step={1}
              marks={{ 0: "Featured", 1: "List View" }}
              onAfterChange={this.changeView}
            />
          </div>
